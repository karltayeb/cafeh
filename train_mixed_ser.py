...
def update_weights(X, Y, pi, beta_means, beta_vars, weights, penalty, param_dict):
    """
...
elbos = [compute_elbo(Y, pi, beta_means, beta_vars, weights, dist, penalty=penalty)]
...
for i in range(maxiter):
    ...
    # update weights
    weight_diff = update_weights(X, Y, pi, beta_means, beta_vars, weights, penalty, param_dict)
    elbos.append(compute_elbo(Y, pi, beta_means, beta_vars, weights, dist, penalty=penalty))
